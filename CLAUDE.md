...
- **Deferred (issue 39 follow-ups)**: fast-scroll date overlay (Apple/Google-Photos style, needs an effective-timestamp on `PhotoDto`); expanded filters (tags, date range, search).
